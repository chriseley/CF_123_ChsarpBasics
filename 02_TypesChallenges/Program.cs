...
//data types: int ,string ,bool ,decimal ,float ,doublie , and ulong . For each of these types, do the following:
...
int numberOfPets = 1;
System.Console.WriteLine(numberOfPets);

bool noCarAccidents = false;
System.Console.WriteLine(noCarAccidents);

bool currentlyEmployed = true;
System.Console.WriteLine(currentlyEmployed);

decimal currentSavings = 1.27;
System.Console.WriteLine(currentSavings);

decimal dominoesPizzaScore = 7.8;
System.Console.WriteLine(dominoesPizzaScore);
